...
parser = argparse.ArgumentParser(
    description='Perform preprocessing (affine transformation, intensity normalization (0 to 1) and histogram equalization (optional)) to input images')
...
parser.add_argument('--atlas', default="../../../data/atlas/icbm152.nii",
                    help="Atlas to use for (affine) pre-registration")  # Todo: check for our data
