...
def calculatePatchIdx3D(num_image, patch_size, image_size, step_size):
	#calculate the idx for 1 3D image - input for each dimension - size of X axes, patch size in X, stride size. 
    # output will be a vector with XYZ indices of all patches
